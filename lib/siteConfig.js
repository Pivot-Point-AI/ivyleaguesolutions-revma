export const siteConfig = {
  ...
  defaultTitle: "Ivy League Solutions – Custom Software, Fintech & Digital Infrastructure",
  description:
    "Ivy League Solutions is a global software development company delivering custom software, fintech platforms, enterprise systems, and digital infrastructure for mid-to-large businesses across the United States and worldwide.",
  email: "contact@ivyleaguesolutions.com",
  phone: "+1 845 300 2429",
  phoneRaw: "+18453002429",
  logo: "/assets/landingPage/ivyleague.png",
  sameAs: [],
  offices: [
    {
