          ...
          {bigBoxes.map((box) => (
            ...
            >
              <div className="absolute top-5 right-5 sm:top-8 sm:right-8 lg:top-[clamp(20px,3.54vw,68px)] lg:right-[clamp(20px,2.81vw,54px)]">
                <Image src="/assets/servicePage/arrow.svg" alt="" aria-hidden="true" width={66} height={66} className="w-9 h-9 sm:w-12 sm:h-12 lg:w-[clamp(36px,3.44vw,66px)] lg:h-[clamp(36px,3.44vw,66px)] transition-all duration-300 group-hover:brightness-0 group-hover:invert" />
              </div>
