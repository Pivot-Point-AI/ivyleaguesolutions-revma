...
export default function ContactHero() {
  return (
    <section className="contact-hero-section relative overflow-hidden bg-[#F8F8F8] pt-[150px] pb-[70px] px-[140px]">
      ...
      <div className="contact-hero-max-w">
        ...
        <h1 className="contact-text-display text-[#242424] font-bold m-0">
          We&apos;re Here To <span className="text-[#4026B8]">Connect</span> And Assist You
        </h1>
        <p className="font-normal text-[#6A6A6A] mt-5 text-[16px] sm:text-[18px] lg:text-[20px] leading-[1.5]">
          Have a project in mind or just want to explore what&apos;s possible? Tell us a
          bit about your goals and our team will get back to you within one business day.
        </p>
      ...
      <div className="absolute hidden lg:block w-[250px] top-[38%] right-[9%] rounded-2xl bg-white border border-black/5 shadow-[0_20px_45px_-15px_rgba(64,38,184,0.22)] p-6 z-[1]">
        ...
        <p className="text-[14.5px] text-[#5A5A5A] leading-[1.55] m-0">
          Get a real response from our team, not an autoresponder, within one business day.
        </p>
      </div>
    </section>
  );
