    ...
    <section className="bg-white overflow-hidden">
      <div className="lg:hidden px-5 sm:px-10 pt-[60px] pb-[60px]">
        ...
        <div className="cs-mobile-img-card mb-6 h-[320px]">
          <Image src="/assets/caseStudy/peopleGroup.svg" alt="Payment team discussing strategy" fill sizes="100vw" />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="cs-mobile-img-card h-[180px]">
            <Image src="/assets/caseStudy/manSitting.svg" alt="12 countries supported" fill sizes="50vw" />
          ...
          <div className="cs-mobile-img-card h-[180px]">
            <Image src="/assets/caseStudy/manTyping.svg" alt="3x volume growth" fill sizes="50vw" />
            <div className="cs-mobile-stat-overlay">
      ...
      <div className="hidden lg:flex mc-desktop-wrap">
        <div className="mc-left-col">
          ...
          <div className="mc-group-wrap">
            <Image src="/assets/caseStudy/peopleGroup.svg" alt="Payment team discussing strategy" fill sizes="(min-width: 1024px) 832px, 100vw" />
        ...
        <div className="mc-right-free">
          <div className="mc-photo-card mc-mansitting">
            <Image src="/assets/caseStudy/manSitting.svg" alt="12 countries supported" fill sizes="370px" />
          ...
          <div className="mc-photo-card mc-mantyping">
            <Image src="/assets/caseStudy/manTyping.svg" alt="3x volume growth" fill sizes="370px" />
            <div className="mc-photo-overlay">
              <div className="ov-num">3x</div>
              <div className="ov-lbl">Volume growth</div>
            </div>
