      ...
      <div className="lg:hidden px-5 sm:px-10 pt-[60px] pb-[60px]">
        ...
        <div className="flex flex-col gap-4">
          <div className="cs-mobile-img-card h-[260px]">
            <Image src="/assets/caseStudy/headphoneMan.webp" alt="Fintech developer" fill sizes="100vw" />
          ...
          <div className="cs-mobile-img-card h-[320px]">
            <Image src="/assets/caseStudy/cardWomen.webp" alt="Mobile banking user" fill sizes="100vw" />
      ...
      <div className="hidden lg:flex mb-desktop-wrap">
        ...
        <div className="mb-images-wrap">
          <div className="mb-img-wrap cs-mb-img-short">
            <Image src="/assets/caseStudy/headphoneMan.webp" alt="Fintech developer" fill sizes="(min-width: 1024px) 40vw, 100vw" />
          ...
          <div className="mb-img-wrap cs-mb-img-tall">
            <Image src="/assets/caseStudy/cardWomen.webp" alt="Mobile banking user" fill sizes="(min-width: 1024px) 40vw, 100vw" />
